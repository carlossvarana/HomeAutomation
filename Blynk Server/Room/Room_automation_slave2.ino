...
char auth[] = "xxxxxxxxxxxxxx"; //You will get this Auth Token in Gmail if you signin Blynk app with your Gmail ID
...
void notifyOnButtonPress()
{
  ...
  if (isButtonPressed) {
  digitalWrite(2,HIGH);
  bridge_luz_cuarto_mesa.virtualWrite(V1,"elc");
  delay(1000);
  }
  else{
  digitalWrite(2,LOW);
  bridge_luz_cuarto_mesa.virtualWrite(V1,"alc");
  delay(1000);
  }
}
